...
var Controls = function ( editor ) {
	...
	var newKeyFrameButton = new UI.Button();
	newKeyFrameButton.setBackground( 'url(files/newKeyFrame.svg)');
	newKeyFrameButton.setWidth( '20px' );
	newKeyFrameButton.setHeight( '20px' );
	newKeyFrameButton.setMarginRight( '5px' );
	newKeyFrameButton.setFloat( 'right' );
	newKeyFrameButton.setVerticalAlign( 'middle' );
	newKeyFrameButton.onClick( function () {
	...
	// options.add( newKeyFrameButton );
	row.add( newKeyFrameButton );
